---
title: "IA: los riesgos que importan — y los derechos que ya tienes"
description: "Sesgos a escala, vigilancia, trabajo transformado, información contaminada, delegación del juicio: los cinco riesgos estructurales de la IA, los debates expuestos con honestidad — y los derechos concretos que el RGPD y el Reglamento de IA ya te dan."
date: "2026-08-23"
category: "ia"
level: "debutant"
draft: false
...
fiche: "/fiches/domaformalis-fiche-12-ia-risques-droits-ES.pdf"
slug: "ia-etica-y-riesgos"
tags: ["inteligencia artificial", "ética", "RGPD", "Reglamento de IA"]
---
...
El itinerario de IA te ha equipado para tu uso personal: [los reflejos](/es/articles/ia-fundamentos), [el funcionamiento](/es/articles/ia-nociones-avanzadas), [los deepfakes](/es/articles/reconocer-los-deepfakes). Pero la IA no te afecta solo cuando la usas: te afecta cuando **otros la usan sobre ti**, para filtrar tu candidatura, evaluar tu crédito, analizar tu rostro, llenar tu feed.
...
**Qué puedes hacer:** a nivel individual, tu palanca sigue siendo [la reducción de exposición](/es/articles/proteger-tu-vida-privada-en-linea), menos materia prima, menos análisis posible. Y tus derechos RGPD (acceso, rectificación, supresión) se aplican también a los datos que alimentan estos sistemas.
...
El coste de producir un texto, una imagen o un vídeo plausibles ha caído casi a cero: el de la verificación, no. Esa **asimetría** es el riesgo sistémico: contenidos masivos generados en cadena, falsos dirigidos ([los deepfakes](/es/articles/reconocer-los-deepfakes)), y un ruido de fondo que hace más difícil distinguir lo auténtico.

**Qué puedes hacer:** tus reflejos ya existen. [la verificación antes de compartir](/es/articles/redes-sociales-uso-responsable), [el test del contexto](/es/articles/reconocer-los-deepfakes). Añade un gesto de ecosistema: dedica tu atención (y en su caso tu dinero) a las fuentes que verifican antes de publicar. En una economía de la atención, eso es un voto.

---

### Riesgo 5 — La delegación del juicio

A nivel individual, conoces [el error 5 de los fundamentos](/es/articles/ia-fundamentos): dejar que la IA piense por ti. El riesgo colectivo es más serio: decisiones administrativas, médicas, judiciales cada vez más *asistidas* por sistemas. Y el sesgo bien documentado que las acompaña, el de **seguir a la máquina porque es la máquina**, incluso cuando se equivoca. El peligro no es que la IA decida: es que el humano que debe controlar deje de controlar de verdad.
...
📄 **[Descarga la ficha «IA: riesgos y derechos»](/fiches/domaformalis-fiche-12-ia-risques-droits-ES.pdf)** — los 5 riesgos, la acción asociada a cada uno y tus derechos europeos, en una página A4.

📘 **[Recibe nuestra guía de IA cuando salga](/es/membres)** — inscríbete y sé avisado en cuanto se publique.

Este artículo es el cuarto del itinerario **Inteligencia artificial**. Anterior: [reconocer los deepfakes](/es/articles/reconocer-los-deepfakes). [el equilibrio digital](/es/articles/equilibrio-digital-recuperar-el-control).
