---
title: "Reconocer los deepfakes: por qué tus ojos ya no bastan — y qué funciona en su lugar"
description: "Voces clonadas, vídeos falsos, imágenes fabricadas: por qué la inspección visual ya no te protege, y los reflejos de contexto que sí lo hacen — devolver la llamada al número conocido, palabra clave familiar, verificación de la fuente."
date: "2026-08-22"
category: "ia"
level: "debutant"
draft: false
...
fiche: "/fiches/domaformalis-fiche-11-deepfakes-ES.pdf"
slug: "reconocer-los-deepfakes"
tags: ["deepfakes", "inteligencia artificial", "estafas", "desinformación"]
---
...
Este artículo es el tercero del itinerario de IA. [Los fundamentos](/es/articles/ia-fundamentos) te enseñaron que la IA genera lo plausible; [bajo el capó](/es/articles/ia-nociones-avanzadas) te mostró por qué. Este saca la consecuencia: **lo plausible se extiende ahora a los rostros y las voces — y tus hábitos de verificación tienen que seguir el ritmo.**

---

## Qué es un deepfake — y por qué ahora es fácil

Un deepfake es un contenido sintético — imagen, vídeo o audio — generado o alterado por IA para mostrar a una persona real haciendo o diciendo algo que nunca hizo ni dijo. La misma familia de tecnologías que genera texto plausible ([ver bajo el capó](/es/articles/ia-nociones-avanzadas)) genera píxeles plausibles y sonido plausible.
...
**La contramedida:** la misma que [para el phishing](/es/articles/reconocer-un-correo-de-phishing), porque es la misma psicología con mejores decorados: **ninguna organización legítima exige acción inmediata por un canal inusual.** Verifica por el canal que ya conoces — el número oficial, la sucursal, el procedimiento interno. En la empresa: toda instrucción de pago recibida por llamada o vídeo se confirma por un segundo canal independiente, sea quien sea quien parezca darla.

### Patrón 3 — El contenido viral impactante

Una figura pública diciendo algo escandaloso, una escena dramática de un conflicto, «imágenes filtradas» — diseñadas para compartirse con rabia. El deepfake se ha vuelto una herramienta estándar de la desinformación, y [la regla del itinerario de redes sociales](/es/articles/redes-sociales-uso-responsable) se aplica al cuadrado: **cuanto más te indigna un vídeo, más merece verificación.**
...
**Limita la materia prima.** La clonación necesita muestras: vídeos públicos de tu voz, fotos en alta resolución desde todos los ángulos. No hace falta desaparecer — pero [la lógica de exposición](/es/articles/proteger-tu-vida-privada-en-linea) se aplica: notas de voz públicas, archivos de vídeo abiertos y perfiles públicos son el combustible. Para los niños, es una razón más para [moderar el sharenting](/es/articles/jovenes-en-linea-5-buenas-practicas).
...
**Este mes:** haz una búsqueda inversa de imagen sobre cualquier imagen viral, solo para instalar el reflejo. Y repasa tu exposición pública de voz/vídeo ([la auditoría de 15 minutos](/es/articles/proteger-tu-vida-privada-en-linea)).
...
📄 **[Descarga la ficha «Deepfakes: los 5 reflejos»](/fiches/domaformalis-fiche-11-deepfakes-ES.pdf)** — el test del contexto y el protocolo telefónico en una página A4, para compartir con tu familia.

📘 **[Recibe nuestra guía de IA cuando salga](/es/membres)** — inscríbete y sé avisado en cuanto se publique.

Este artículo es el tercero del itinerario **Inteligencia artificial**. Anterior: [IA — bajo el capó](/es/articles/ia-nociones-avanzadas). [el equilibrio digital](/es/articles/equilibrio-digital-recuperar-el-control).
