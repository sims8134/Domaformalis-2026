---
title: "How to Recognize a Phishing Email: 5 Signs That Never Lie"
description: "The 5 most reliable signs of a phishing email, how ransomware reaches your device, and the 60-second rule so you never reply under pressure again."
date: "2026-08-13"
...
fiche: "/fiches/domaformalis-fiche-02-phishing-EN.pdf"
slug: "recognize-a-phishing-email"
tags: ["cybersecurity", "phishing", "ransomware", "online safety"]
---

# How to Recognize a Phishing Email: 5 Signs That Never Lie
...
## The 5 signs an email isn't what it claims to be

### Sign 1 — The real address doesn't match the displayed identity
...
### Sign 3 — Links that lead somewhere other than what they display
...
### Sign 5 — Requests for personal information by email
...
### Trap 1 — Trusting the visual appearance
...
The fear of losing access to an account, or missing a deadline, is precisely the emotion phishing exploits. Under that pressure, it's easy to reply without thinking.

**What to do instead:** adopt a personal rule: any email requesting sensitive information requires prior independent verification. Call a number you already have. Log in to the site directly. If the problem is real, it will still be there after you've checked.
...
**Step 3 — Apply the 60-second rule.** Every time an email creates urgency, give yourself 60 seconds before doing anything. Open a new tab, go directly to the organization's website, check whether the problem is real. In almost every case, it won't be.
...
Even experienced users receive phishing emails that are genuinely hard to identify. The most sophisticated attacks are designed by professionals who know exactly how to make them convincing.

The goal is not to become impossible to fool. The goal is to slow down, verify, and never hand over sensitive information under pressure. That single habit protects you from the vast majority of attempts.

---

## To go further

📄 **[Download the "Recognize a Phishing Email" cheat sheet](/fiches/domaformalis-fiche-02-phishing-EN.pdf)** — the 5 signs and the 60-second rule on one A4 page, to keep next to your screen.

📘 **[Get the full "Internet & Scams" guide](/en/membres)** — our detailed guide, free, sent by email upon simple sign-up.

This article is the second in the **Internet Security** track. Previous: [avoiding online scams](/en/articles/avoiding-online-scams). Next step: [protect your private life online](/en/articles/protect-your-private-life-online).
