---
title: "AI: The Risks That Matter — and the Rights You Already Have"
description: "Bias at scale, surveillance, transformed work, polluted information, delegated judgment: AI's five structural risks, the debates laid out honestly — and the concrete rights the GDPR and the AI Act already give you."
date: "2026-08-23"
category: "ia"
level: "debutant"
draft: false
...
fiche: "/fiches/domaformalis-fiche-12-ia-risques-droits-EN.pdf"
slug: "ai-ethics-and-risks"
tags: ["artificial intelligence", "ethics", "GDPR", "AI Act"]
---
...
The AI track has equipped you for your personal use: [the reflexes](/en/articles/ai-foundations), [how it works](/en/articles/ai-advanced-notions), [deepfakes](/en/articles/recognize-deepfakes). But AI doesn't only concern you when you use it: it concerns you when **others use it on you**, to sort your job application, score your credit, analyze your face, fill your feed.
...
**What you can do:** at the individual level, your lever remains [exposure reduction](/en/articles/protect-your-private-life-online), less raw material, less possible analysis. And your GDPR rights (access, rectification, erasure) also apply to the data feeding these systems.
...
The cost of producing plausible text, images or video has fallen to nearly zero: the cost of verification has not. That **asymmetry** is the systemic risk: mass-generated content, targeted fakes ([deepfakes](/en/articles/recognize-deepfakes)), and a background noise that makes the authentic harder to distinguish.

**What you can do:** your reflexes already exist. [verification before sharing](/en/articles/social-media-responsible-use), [the context test](/en/articles/recognize-deepfakes). Add an ecosystem-level act: give your attention (and where relevant your money) to sources that verify before publishing. In an attention economy, that is a vote.

---

### Risk 5 — Delegated judgment

At the individual level, you know [mistake 5 from the foundations](/en/articles/ai-foundations): letting AI think in your place. The collective risk is more serious: administrative, medical and judicial decisions increasingly *assisted* by systems. And the well-documented bias that comes with it, that of **following the machine because it's the machine**, even when it's wrong. The danger is not that AI decides: it's that the human supposed to oversee stops truly overseeing.
...
📄 **[Download the "AI: Risks and Rights" cheat sheet](/fiches/domaformalis-fiche-12-ia-risques-droits-EN.pdf)** — the 5 risks, the action attached to each, and your European rights, on one A4 page.

📘 **[Get our AI guide when it's released](/en/membres)** — sign up and be notified as soon as it's published.

This article is the fourth in the **Artificial Intelligence** track. Previous: [recognizing deepfakes](/en/articles/recognize-deepfakes). [digital balance](/en/articles/digital-balance-take-back-control).
