        ...
        <table width="560" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:8px;padding:40px;border:1px solid #e2e8f0;">
          <tr>
            <td align="center" style="padding-bottom:24px;">
              <img src="${BASE_URL}/img/logo_domaformalis_email.png" alt="Domaformalis" width="120" height="120" style="display:block;width:120px;height:120px;border:0;outline:none;text-decoration:none;" />
            </td>
          </tr>
          <tr>
