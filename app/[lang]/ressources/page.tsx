...
export default async function RessourcesPage({
  ...
  return (
    <main>
      ...
      <RessourcesFiches dict={dict} lang={lang} />
      {/* RessourcesLinks retiré : section placeholder, à réintroduire quand
          de vrais liens existeront (composant conservé dans /components). */}
